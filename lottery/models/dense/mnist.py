...
training_set = datasets.MNIST(DATA_PATH, train=True, download=True, transform=forward_transform)
...
forward_representative_loader = torch.utils.data.DataLoader(test_set,
                                                            batch_size=1,
                                                            num_workers=1,
                                                            shuffle=True,
                                                            pin_memory=False)
